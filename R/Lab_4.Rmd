...
voroni_dam_plot = pip_plot(dams_voroni, "Voroni Tesselation of US Dams")

tri_dam_plot = pip_plot(dams_tri, "Triangulation Tesselation of US Dams")

grd_dam_plot = pip_plot(dams_grd, "Grid Tesselation of US Dams")

hex_dam_plot = pip_plot(dams_hex, "Hexagonal Tesselation of US Dams")

county_dam_plot = pip_plot(dams_county, "County Lines of US Dams")
